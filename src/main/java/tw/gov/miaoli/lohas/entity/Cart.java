package tw.gov.miaoli.lohas.entity;
...
@Table(catalog = "\"MiaoliLohasDB\"", schema = "\"public\"", name = "\"Cart\"", uniqueConstraints = {
...
public class Cart implements java.io.Serializable {
	 ...
	 * @param packet 訂單
	 */
	public Cart(Merchandise merchandise, String specification, short quantity, int price, Packet packet) {
